...
import UserProfile from 'ui/Header/UserProfile'
...
const SidebarItem = ({
  ...
  const isActive = slug === '/' ? pathname === slug : pathname.includes(slug)

  return (
    <li
      className={`group px-3 py-2 rounded-lg mb-1 last:mb-0  ${
        isActive ? 'bg-blue-600 hover:bg-blue-600' : 'hover:bg-blue-100'
      } duration-300 ease-in-out`}
    >
      <Link
        href={`${slug}`}
        className={`relative flex items-center gap-2 rounded-sm py-2 px-4 font-medium ${
